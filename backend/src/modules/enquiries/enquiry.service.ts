...
/**
 * Generates the next enquiry number.
 *
 * The number is generated by the backend rather than the frontend
 * so users cannot control the business identifier.
 */
async function generateEnquiryNumber(
  ...
  const lastNumber = Number(
    latestEnquiry.enquiryNumber.replace('ENQ-', ''),
  );
...
export async function createEnquiry(
  ...
  return prisma.$transaction(async (tx) => {
    ...
    /**
     * Generate the enquiry number on the backend.
     */
    const enquiryNumber =
